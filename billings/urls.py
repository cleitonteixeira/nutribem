...
urlpatterns = [
    ...
    path('dashboard_financial/', views.dashboard_financial, name="dashboard_financial"),
    path('dashboard_purchasing/', views.dashboard_purchasing, name="dashboard_purchasing"),
    path('requests/<int:codigo>', views.requests, name="requests"),
